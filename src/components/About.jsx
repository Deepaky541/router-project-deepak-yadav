    ...
    <div className="about">
      ...
      <div className="para1">
        ...
        <p>
          ...
          are overwhelmed by products made to break down, wear out or go out
          style, we aim to go against that grain.
        </p>
      </div>
      <div className="para2">
        <div>
          ...
          <p>
            ...
            of our individual lifestyle. When a product improves and patinas
            with use, it carries the history of its user, of places traveled and
            memories made.
          </p>
        </div>
        <div>
      ...
      <div className="para3">
        ...
        <div>
          ...
          <p>
            ...
            reverberates internally, building in amplitude and challenging each
          ...
          <p>
            ...
            We believe in putting others first. We are a progressive company
            that echos the values and ideals of our own community in Portland
